...
export default function HomePage() {
  ...
  useEffect(() => {
    const propertyTimer = setInterval(cycleToNextLeftProperty, 5000);
    return () => clearInterval(propertyTimer);
  }, [cycleToNextLeftProperty]);

  // Auto-cycle right column properties every 5 seconds
  useEffect(() => {
    const propertyTimer = setInterval(cycleToNextRightProperty, 5000);
    return () => clearInterval(propertyTimer);
...
//   // Update active house when property index changes
//   useEffect(() => {
//     if (houses.length > 0) {
...
//   // Auto-cycle properties every 5 seconds
//   useEffect(() => {
//     const propertyTimer = setInterval(cycleToNextProperty, 5000);
//     return () => clearInterval(propertyTimer);
//   }, [cycleToNextProperty]);
...
//       {/* Left Column Content */}
//       <div className="w-1/2 overflow-y-auto">
//         {/* Topbar - Previous code remains the same */}
//         <div className="p-6 border-b flex items-center justify-between">
...
//             </div>
//             <button 
//               onClick={() => router.push(`/house/${activeHouse.id}`)}
//               className="px-6 py-2 bg-teal-600 text-white rounded-sm hover:bg-teal-700 transition-colors"
//             >
...
//         {/* Sell Section - Previous code remains the same */}
//         <div id="sell-section" className="p-6 bg-gray-50 mt-8">
//           <h2 className="text-2xl font-bold mb-4">Ready to Sell Your Property?</h2>
//           <p className="text-gray-600 mb-4">List your property and reach thousands of potential buyers</p>
//           <button className="px-6 py-2 bg-teal-600 text-white rounded-sm hover:bg-teal-700 transition-colors">
...
//       <div className="w-1/2 relative">
//         {/* Search and Login - Previous code remains the same */}
//         <div className="absolute top-0 left-0 right-0 p-6 z-10 flex justify-between items-center">
//           <div className="relative flex-1 max-w-md">
//             <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
//             <input
...
//         <div className="absolute inset-0 bg-gray-200 overflow-hidden">
//           <Image 
//             key={activeHouse.id} // Add key to force re-render
//             src={activeHouse.images[currentImageIndex]} 
//             alt={activeHouse.title}
//             layout="fill"
//             objectFit="cover"
